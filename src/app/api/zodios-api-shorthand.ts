...
type StatusCode = LiteralUnion<`${(typeof HttpStatusCode)[keyof typeof HttpStatusCode]}`>
...
type ParameterPath<T extends keyof ZodiosTypes, K, V, D> =
  V extends z.ZodType<unknown, z.ZodTypeDef, unknown>
    ? K extends string
      ? {
          type: T
          name: K
